  ...
  return (
    <div className={styles.mobileNavContainer}>
      <div className={styles.mobileNavBtns}>
        <NavLink to="/mtg" className={resolveActiveStyle}>
          Magic: The gathering
        </NavLink>
        <NavLink to="/sleeves" className={resolveActiveStyle}>
          card sleeves
        </NavLink>
        <NavLink to="/playmats" className={resolveActiveStyle}>
          playmats
        </NavLink>
        <NavLink to="/cards" className={resolveActiveStyle}>
          cards
        </NavLink>
        <NavLink to="/albums" className={resolveActiveStyle}>
          albums
        </NavLink>
        <NavLink to="/card-boxes" className={resolveActiveStyle}>
          card storage
        </NavLink>
      </div>
